               ...
               <form onSubmit={onSubmitHandler}>
                   {
                       isCreateAccount && (
                           <div className="mb-3">
                               ...
                               <input type="text" id="fullName" className="form-control" placeholder="Enter Full Name"  required onChange={(e)=>setName(e.target.value)}
                               value={name}/>
                           </div>
                       )
                   }
                   ...
                   <div className="mb-3">
                       ...
                       <input type="password" id="password" className="form-control" placeholder="******"  required onChange={(e)=>setPassword(e.target.value)}
                       value={password}/>
                   </div>
                   ...
                   <p className="mb-0">
                       {isCreateAccount?(
                           <>
                               ...
                               <span
                                   onClick={()=> setIsCreateAccount(false)} className="text-decoration-underline"style={{cursor:"pointer"}}>
                               Login Here
                           </span>
                           </>
                       ): (
                           <>
                               ...
                               <span
                                   onClick={()=> setIsCreateAccount(true)} className="text-decoration-underline" style={{cursor:"pointer"}}>
                                   Sign Up
                               </span>
                           </>
                       )
